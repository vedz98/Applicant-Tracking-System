...
<div class="row">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="name">Requester's Name</label>
    <div class="col-sm-9"> 
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="contact">Requester's Contact</label>
    <div class="col-sm-9"> 
  ...
  <h5 style="margin-top:40px;">Request Details</h5><hr style="margin-top: 10px;">
    <div class="form-group">
    <label class="control-label col-sm-2" for="date">Request Date</label>
    <div class="col-sm-9">
